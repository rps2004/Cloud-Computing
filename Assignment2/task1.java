...
public class TopRoutes2012Global {

    // Mapper: emit (route, 1) for 2012
    public static class RouteCountMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
    ...
    // Reducer: sum counts and keep top 5
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            System.err.println("Usage: TopRoutes2012Global <inputCsv> <finalOutput>");
            System.exit(2);
        }
        ...
        Job job = Job.getInstance(conf, "Top 5 Routes 2012 - Single Job");
        job.setJarByClass(TopRoutes2012Global.class);

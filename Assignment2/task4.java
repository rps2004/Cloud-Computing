...
public class TopNightSpots2012 {

    // Mapper: emit (pickup_location, 1) and (drop_location, 1) for trips between 8 PM and 2 AM
    public static class NightSpotMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            Matcher m = datetimePattern.matcher(pickupDatetime);
            if (!m.find()) return;
            ...
            // Night hours: 20 (8 PM) to 23 and 0 to 1
    ...
    public static class Top5NightReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            System.err.println("Usage: TopNightSpots2012 <inputCsv> <finalOutput>");
            System.exit(2);
        }
        ...
        Job job = Job.getInstance(conf, "Top 5 Night Life Spots 2012 - Single Job");
        job.setJarByClass(TopNightSpots2012.class);

        job.setMapperClass(NightSpotMapper.class);
        job.setReducerClass(Top5NightReducer.class);
